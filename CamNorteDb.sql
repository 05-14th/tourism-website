...
INSERT INTO USER VALUES(1000, "administrator", "Gerry Vien Flores", "gerryvienlifeflores@gmail.com", "4dm1n_P4ss", "09187286079", 2023-12-14, "Admin"); 
...
CREATE TABLE delicacy(
    `delicacy_id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `delicacy_name` VARCHAR(255) NOT NULL,
    `image` VARCHAR(255) NOT NULL,
    `description` VARCHAR(255) NOT NULL
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=UTF8MB4_GENERAL_CI;

ALTER TABLE `delicacy` ADD COLUMN `ratings` INT(1) DEFAULT 0;

CREATE TABLE accredited_businesses(
    `business_id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `business_name` VARCHAR(255) NOT NULL,
    `image` VARCHAR(255) NOT NULL,
    `description` VARCHAR(255) NOT NULL,
    `location` VARCHAR(255) NOT NULL,
    `ratings` INT(1) DEFAULT 0
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=UTF8MB4_GENERAL_CI;
